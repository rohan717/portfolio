...
{ 
    ...
    $from_email         = $_POST["sender_email"]; //from mail, sender email addrress 
    $recipient_email    = 'recipient@xyz.com'; //recipient email addrress 
      
    //Load POST data from HTML form 
    $sender_name    = $_POST["sender_name"]; //sender name 
    $reply_to_email = 'rohansawant717@gmail.com'; //sender email, it will be used in "reply-to" header 
    $phone        = $_POST["sender_phone"]; //subject for the email 
    $subject        = $_POST["subject"]; //body of the email 
